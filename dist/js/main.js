...
const router = require('./router');
const debug = require('./debug');
const trunks = require('./trunks/index');
...
},{"./debug":74,"./router":77,"./trunks/index":80}],79:[function(require,module,exports){
...
},{"./config":73,"./debug":74,"./request":76,"lodash/template":70}],80:[function(require,module,exports){
module.exports = {
	init(params) {
